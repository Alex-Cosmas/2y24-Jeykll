  ...
  class PaginatedVideoPage < Page
    def initialize(site, dir, basename, total_pages, videos_list)
      ...
      @data = {
        ...
        'title' => "Videos by Alex Cosmas#{page_description} | Software Developer",
        'description' => "A collection of all the youtube videos posted by Alex Cosmas#{page_description}"
      }
    end
